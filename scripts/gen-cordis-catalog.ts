...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TeamDocWriteOptions: 'kb team doc write options are owned by packages/kb/kb-core/README.md',
  TeamDocWriteResult: 'kb team doc write output is owned by packages/kb/kb-core/README.md',
  ...
  KbWorkbenchDoc: 'kb workbench team doc view is owned by packages/kb/kb-web/README.md',
  KbWorkbenchDocOptions: 'kb workbench team doc options are owned by packages/kb/kb-web/README.md',
  ...
  Card: 'card model is owned by packages/kb/kb-core/README.md',
  ...
  CardGrade: 'card model governance grade is owned by packages/kb/kb-core/README.md',
  PackEntry: 'kb pack selection entry is owned by packages/kb/kb-core/README.md',
  TeamCardFileInfo: 'kb team storage entry is owned by packages/kb/kb-core/README.md',
  GitRunResult: 'kb git surface output is owned by packages/kb/kb-core/README.md',
  GateVerdict: 'kb governance verdict is owned by packages/kb/kb-core/README.md',
  FreshnessPosition: 'kb freshness position is owned by packages/kb/kb-core/README.md',
  FreshnessRecommendation: 'kb freshness recommendation is owned by packages/kb/kb-core/README.md',
  FreshnessReview: 'kb freshness output is owned by packages/kb/kb-core/README.md',
