...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  // The settings shell: panel chrome, section navigation, and the trigger.
  { id: '@deepseek-ai/dsh-client-ui-settings-general', bundlePath: 'packages/client/ui-settings-general/lib/client.js', url: '/plugins/ui-settings-general.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-connection', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-client-ui-sidebar', '@deepseek-ai/dsh-api-remotes'] },
  // The knowledge-base governance workbench settings section (fixture data).
  { id: '@deepseek-ai/dsh-client-ui-kb-workbench', bundlePath: 'packages/client/ui-kb-workbench/lib/client.js', url: '/plugins/ui-kb-workbench.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-api-remotes'] },
