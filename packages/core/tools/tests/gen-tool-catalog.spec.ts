...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'kb_archive', 'kb_freshness', 'kb_gate_check', 'kb_promote', 'kb_read', 'kb_recap',
      'kb_review', 'kb_revive', 'kb_search', 'kb_team_commit', 'kb_team_promote',
      'kb_team_read', 'kb_team_status', 'kb_write',
