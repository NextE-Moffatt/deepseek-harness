...
| [`kb/`](kb/README.md) | Knowledge-base family: card model, personal-library storage, promotion state machine, FTS5 search, incremental ingest, `kb_*` tools | Product — stable API |
