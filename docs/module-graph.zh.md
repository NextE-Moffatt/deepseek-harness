...
flowchart TD
  ...
  pkg_kb_core --> pkg_agent
  pkg_kb_core --> pkg_brand
  pkg_kb_core --> pkg_invariants
  pkg_kb_core --> pkg_jobs
  pkg_kb_core --> pkg_session
  pkg_kb_core --> pkg_tools
...
| [`kb-core`](../packages/kb/kb-core) | `kb` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`jobs`](../packages/jobs/jobs), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
